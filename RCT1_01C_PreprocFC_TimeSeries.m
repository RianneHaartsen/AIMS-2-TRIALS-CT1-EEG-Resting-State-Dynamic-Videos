%% RCT_01C: pre-processing - version C) Functional connectivity
...
% - segmenting stimuli data into epochs (1-sec duration with 50% overlap)
                ...
                if interp_epoch==1 % check epoch level channel interpolation
                    ...
                    if all_bad_epochs==1
                        ...
                        for ei=1:EEG.trials
                            ...
                            if sum(NumbadChan) > round((10/100)* size(chans_labels2,2))% check if more than 10% of 19 channels are bad
