%% RCT1_01A: pre-processing - version A) Power metric
...
output_location = 'xxx/DATA/01A_PreprocPower';
...
load xxxx/DATA/01_Preproc_Filtered_Continuous/miniMADE_filtered_report.mat
...
for subject = 1:height(miniMADE_filtered_table)
    ...
    try
        %% STEP 1: Import EEGlab data file and relevant information
